    ...
    final class MessageUiProfileTest extends TestCase
    {
        ...
        public static function tabKeyProvider(): array
        {
            return [
                ...
                'Sinch'           => [ServiceType::SINCH, 'fax', ['received', 'sent', 'upload']],
        ...
        public static function columnCountProvider(): array
        {
            return [
                ...
                'Sinch received (7)'       => [ServiceType::SINCH, 'fax', 'received', 7],
                'Sinch sent (7)'           => [ServiceType::SINCH, 'fax', 'sent', 7],
        ...
        public static function dropzoneProvider(): array
        {
            return [
                ...
                'Sinch'           => [ServiceType::SINCH, 'fax', true],
